...
//                let name = fieldRecords[i].fieldName
//                if let cMangledTypeName = fieldRecords[i].mangledTypeName,
//                    let fieldType = _getTypeByMangledNameInContext(
//                        cMangledTypeName,
//                        getMangledTypeNameSize(cMangledTypeName),
//                        genericContext: self.contextDescriptorPointer,
//                        genericArguments: self.genericArgumentVector) {
//                    result.append(Property.Description(key: name, type: fieldType, offset: fieldOffsets[i]))
//                }
//            }
            ...
            for i in 0..<self.numberOfFields {
                ...
                guard let cMangledTypeName = fieldRecords[i].mangledTypeName else { continue }
